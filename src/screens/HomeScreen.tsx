...
export default function HomeScreen() {
        ...
        <TouchableOpacity className="flex-row items-center p-3">
            ...
            <View className="ml-3 flex-1">
                ...
                <Text
                    ...
                    numberOfLines={1}
                    ellipsizeMode="tail">{item.lastMessage}
                </Text>
            </View>
    ...
    return (
        <SafeAreaView className="flex-1 mt-5" edges={["right", "bottom", "left"]}>
            {/* Search bar */}
            <View className="items-center flex-row mx-2 bg-gray-300 rounded-full px-3 h-14">
